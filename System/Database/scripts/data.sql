...
INSERT INTO Partner_Status(id, name)
    VALUES(1, 'Activo'), (2, 'Vitalicio'), (3, 'Inactivo');

INSERT INTO Addresses(id, address, city, phone)
    VALUES(1, 'Tuyutí 7126', 1, '1146414581');

INSERT INTO Persons(id, doc_type, doc_number, social_security, last_name, first_name, birthdate, sex, address, cellphone)
    VALUES(1, 2, 14009938, '140307131409/00', 'Córdoba', 'Adrián Esteban', '08-29-1960', 2, 1, '1157385359');


INSERT INTO Partners(id, person, partner_number, incorporation, position, status)
    VALUES(1, 1, 234, '01-01-2026', 1, 1);
...
INSERT INTO News(id, event, creation, brief, description)
